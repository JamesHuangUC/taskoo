<?php
include("inc/taskerheader.php");
include("incdata/connection_edittask.php");
?>
<?php
$dbconn = pg_connect("host=localhost port=5432 dbname=taskoo user=postgres password=tessa")
    or die('Could not connect: ' . pg_last_error());
$query = "SELECT title, location, taskdate, timerange, price, description, category FROM taskoo_task
