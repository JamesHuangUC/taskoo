...
$query = "SELECT title, location, taskdate, timerange, price, taskid FROM taskoo_task WHERE helper='".$_SESSION["email"]."' ORDER BY postdate DESC, posttime DESC";
...
while ($row = pg_fetch_row($result)){
  ...
  $row[4] . '/hr</p></div>
  <div class="col s3"><br>
    <a href="../taskdetails_helperview.php?taskid='.$row[5].'" class="secondary-content"><i class="material-icons">visibility</i></a></div>
</div>
  </li>';
}
