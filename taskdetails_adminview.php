...
$query = "SELECT title, location, taskdate, timerange, price, description, category, t.name, helper, postdate FROM taskoo_task, taskoo_user t
...
<div class="row"><br>
  ...
  <div class="col m6">
    ...
    <a href='incdata/deletetask_admin.php?<?php echo "taskid=".$_GET["taskid"];?>' class="waves-effect waves-teal btn inbtn">Delete</a> &nbsp;
    <a href='edittask_admin.php?<?php echo "taskid=".$_GET["taskid"];?>' class="waves-effect waves-teal btn inbtn">Edit</a><br><br><br>
  </div>
  <div class="col m3"></div>
</div>
